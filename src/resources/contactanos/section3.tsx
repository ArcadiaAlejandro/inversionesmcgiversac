...
const FAQ_DATA: FAQItem[] = [
  {
    question: '1. Información Acerca de Inverisones McGuiver',
    answer: '',
    subItems: [
      {
  ...
  {
    question: '2. Información de Nuestros Servicios',
    answer: '',
    subItems: [
      {
  ...
  {
    question: '3. Información de Proyectos y Precios',
    answer: '',
    subItems: [
      {
  ...
  {
    question: '4. Información sobre la Experiencia y Satisfacción',
    answer: '',
    subItems: [
      {
  ...
  {
    question: '5. Información sobre Nuestas Garantías y Protocolos de Seguridad',
    answer: '',
    subItems: [
      {
  ...
  },
  {
    ...
    subItems: [
      {
        question: '6.1 ¿Cómo puedo hacer seguimiento a mi consulta?',
      ...
      {
        question: '6.2 ¿Cómo puedo hacer una consulta general?',
        answer: 'Para consultas generales, utiliza nuestro formulario de contacto. Incluye toda la información relevante para que podamos ofrecerte una respuesta precisa y rápida.',
      },
      {
        question: '6.3 ¿Qué debo incluir en mi mensaje?',
      ...
      {
        question: '6.4 ¿Dónde están ubicadas tus oficinas?',
        answer: 'Puedes encontrarnos en URB. los parques de Carabayllo - DPTO 204 - Edificio 3, Etapa II - Lim. Utiliza el mapa que esta más arriba para ver nuestra ubicación exacta y planificar tu visita.',
      },
      {
        question: '6.5 ¿Cuál es el mejor canal para soporte técnico?',
        answer: 'Para soporte técnico, te recomendamos enviar un correo electrónico a inversionesmcgiver@gmail.com o llamarnos al (+51) 939-894-269 durante nuestro horario de atención.',
      },
      {
        question: '6.6 ¿Puedo solicitar una reunión en persona?',
        answer: 'Sí, puedes solicitar una reunión en persona. Envía un correo electrónico a inversionesmcgiver@gmail.com con tu disponibilidad y el propósito de la reunión, y te coordinaremos una cita.',
      },
      {
        question: '6.6 ¿Ofrecen soporte fuera del horario laboral?',
        answer: 'Nuestro soporte principal está disponible de lunes a viernes, de 8:00 AM a 6:30 PM. Para asuntos urgentes fuera de este horario, contacta a inversionesmcgiver@gmail.com y haremos lo posible por asistirte.',
      },
    ],
  },
];
